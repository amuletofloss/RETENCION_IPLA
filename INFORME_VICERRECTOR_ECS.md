...
MRUN, identificador enmascarado oficial, se utiliza exclusivamente en el procesamiento local y no se publica fila a fila. El repositorio no utiliza RUT y permite conciliar los resultados aprobados mediante `datos/controles_publicos/`, el catálogo de fuentes, hashes y pruebas sintéticas.
