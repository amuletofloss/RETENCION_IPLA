...
|---|---|---|
| Fuentes SIES descargadas | Datos abiertos de origen | Solo `.sies-local/raw`; nunca Git |
| CSV analíticos longitudinales | Datos abiertos derivados | Solo `.sies-local/derived`; nunca Git |
| Controles agregados | Datos públicos protegidos | Umbral mínimo 10 y supresión complementaria |
| `MRUN` | Identificador enmascarado técnico | Uso local como texto; oculto en modelo; nunca publicación fila a fila |
...
|---|---|---|
| Exponer MRUN en Git, visual o exportación | Alta | `external_mrun`, CI, campo oculto y revisión de release |
| Revelar grupos pequeños por agregación | Alta | umbral 10 y supresión complementaria |
...
El canal operativo se define en [SECURITY.md](../SECURITY.md). Se recomienda habilitar Private Vulnerability Reporting y secret scanning en GitHub.
