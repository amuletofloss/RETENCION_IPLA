...
| [03 · DAX](03-dax.md) | Inventario, convenciones, dependencias y controles | BI, QA | Vigente 3.3.1 |
| [04 · Power Query](04-power-query.md) | Fuentes, parámetros, materialización y linaje | Datos, BI | Vigente |
| [05 · Reporte](05-reporte.md) | Páginas, visuales, interacción y ECS | BI, negocio, QA | Vigente 3.3.1 |
...
| [12 · Estándar reutilizable](12-estandar-reutilizable.md) | Contrato y generador `crear_pbip_github` | Arquitectura, desarrollo | Candidato 1.0 |
...
flowchart TB
  ...
  F[Matrícula y Titulados SIES] --> P[materializar_datos.py]
  P --> D[derivados locales .sies-local]
  D --> W[workspace .sies-work]
  W --> S
  B[construir_pbip.mjs] --> R
  B --> S
  R --> V[Power BI Desktop / servicio]
  S --> V
  T[tests + CI] --> C[controles agregados públicos]
  T --> R
  T --> S
