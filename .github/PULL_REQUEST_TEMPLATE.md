...
- [ ] No contiene rutas personales, secretos, fuentes SIES ni derivados fila a fila con MRUN.
- [ ] Los agregados públicos cumplen umbral 10 y supresión complementaria.
...
- [ ] El gate `CI / gate` finaliza correctamente.
