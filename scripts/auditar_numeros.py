...
def main() -> None:
    ...
    parser.add_argument("--data", type=Path, default=ROOT / ".sies-local/derived/retencion_academica_sies")
    parser.add_argument("--output", type=Path, default=ROOT / ".sies-local/auditoria")
