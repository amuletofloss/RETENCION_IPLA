...
La fuente exclusiva es el derivado local iplacex_procedencia_cohortes.csv, materializado
...
CSV_PATH = ROOT / ".sies-local/derived/retencion_academica_sies/iplacex_procedencia_cohortes.csv"
MD_PATH = ROOT / ".sies-local/auditoria/ANALISIS_PROCEDENCIA_PRIMER_ANO_IPLACEX_DETALLE.md"
PDF_PATH = ROOT / "dist/TABLA_MATRICULA_PRIMER_ANO_IPLACEX.pdf"
PDF_V2_PATH = ROOT / "dist/TABLA_MATRICULA_PRIMER_ANO_IPLACEX_AUDITADA.pdf"
